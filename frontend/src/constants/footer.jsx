...
function Footer() {
  ...
  return (
    <footer className="flex flex-col md:flex-row justify-center md:justify-between lg:justify-around items-center  w-full min-h-80 max-h-full gap-x-4 p-4 max-sm:gap-y-10 sm:gap-y-10 bg-black border-t-2 drop-shadow-md border-muted/30 ">
        ...
        <div className="flex flex-col justify-start  relative ">
          <form action="" className="flex flex-col justify-center ">
            ...
            <div className="flex flex-row justify-start items-start gap-x-2">
              ...
              />
              <button className="p-1 rounded-sm text-destructive border-2 border-amber-400">
                Submit
              </button>
            </div>
          </form>
          <div>
            <h1 className="text-2xl text-orange-400 font-bold mt-4 mb-4">
              Follow Us
            </h1>
            <ul className="flex flex-row gap-4">
              <li>
                <Instagram className="stroke-white bg-white/20 p-2 h-10 w-10 rounded-2xl"></Instagram>
              </li>
              <li>
                <Github className="stroke-white bg-white/20 p-2 h-10 w-10 rounded-2xl "></Github>
              </li>
              <li>
                <Linkedin className="stroke-white bg-white/20 p-2 h-10 w-10 rounded-2xl"></Linkedin>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div>
        <div className="grid grid-cols-2 gap-2 place-content-center">
          <ul className="flex flex-col justify-center gap-y-2">
            <li className="text-orange-400 font-bold text-lg">Menu</li>
          ...
          <ul className="flex flex-col justify-center gap-y-2">
            <li className="text-orange-400 font-bold text-lg">Support</li>
        ...
        <div>
          <p className="text-center text-orange-400 mt-5">
