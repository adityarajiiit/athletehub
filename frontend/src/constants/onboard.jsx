...
function Onboard(props) {
  ...
  return (
    <div className="flex justify-center items-center w-full min-h-screen h-full bg-black/85 z-40 p-4">
      <div className="bg-gradient-to-r from-[#0F044C] via-purple-900 to-[#141E61] shadow-md shadow-slate-200/10 rounded-md w-11/12 max-w-lg border-2 border-secondary/50">
        ...
        <form
          ...
          className="bg-white rounded-md p-6 z-50 max-h-[45rem] overflow-y-auto custom-scrollbar"
        >
